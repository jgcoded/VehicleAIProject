...
#include "VehicleAIProjectWheelRear.h"
...
const FName AVehicleAIProjectPawn::LookUpBinding("LookUp");
const FName AVehicleAIProjectPawn::LookRightBinding("LookRight");
const FName AVehicleAIProjectPawn::EngineAudioRPM("RPM");

#define LOCTEXT_NAMESPACE "VehiclePawn"

AVehicleAIProjectPawn::AVehicleAIProjectPawn()
{
	// Car mesh
	...
	// Wheels/Tyres
	// Setup the wheels
	Vehicle4W->WheelSetups[0].WheelClass = UVehicleAIProjectWheelFront::StaticClass();
	Vehicle4W->WheelSetups[0].BoneName = FName("PhysWheel_FL");
	Vehicle4W->WheelSetups[0].AdditionalOffset = FVector(0.f, -8.f, 0.f);

	Vehicle4W->WheelSetups[1].WheelClass = UVehicleAIProjectWheelFront::StaticClass();
	Vehicle4W->WheelSetups[1].BoneName = FName("PhysWheel_FR");
	Vehicle4W->WheelSetups[1].AdditionalOffset = FVector(0.f, 8.f, 0.f);

	Vehicle4W->WheelSetups[2].WheelClass = UVehicleAIProjectWheelRear::StaticClass();
	Vehicle4W->WheelSetups[2].BoneName = FName("PhysWheel_BL");
	Vehicle4W->WheelSetups[2].AdditionalOffset = FVector(0.f, -8.f, 0.f);

	Vehicle4W->WheelSetups[3].WheelClass = UVehicleAIProjectWheelRear::StaticClass();
...
void AVehicleAIProjectPawn::SetupPlayerInputComponent(class UInputComponent* InputComponent)
{
	// set up gameplay key bindings
	check(InputComponent);

	InputComponent->BindAxis("MoveForward", this, &AVehicleAIProjectPawn::MoveForward);
	InputComponent->BindAxis("MoveRight", this, &AVehicleAIProjectPawn::MoveRight);
	InputComponent->BindAxis(LookUpBinding);
	InputComponent->BindAxis(LookRightBinding);

	InputComponent->BindAction("Handbrake", IE_Pressed, this, &AVehicleAIProjectPawn::OnHandbrakePressed);
	InputComponent->BindAction("Handbrake", IE_Released, this, &AVehicleAIProjectPawn::OnHandbrakeReleased);
	InputComponent->BindAction("SwitchCamera", IE_Pressed, this, &AVehicleAIProjectPawn::OnToggleCamera);

	InputComponent->BindAction("ResetVR", IE_Pressed, this, &AVehicleAIProjectPawn::OnResetVR); 
}

void AVehicleAIProjectPawn::MoveForward(float Val)
{
	GetVehicleMovementComponent()->SetThrottleInput(Val);

}

void AVehicleAIProjectPawn::MoveRight(float Val)
{
	GetVehicleMovementComponent()->SetSteeringInput(Val);
}

void AVehicleAIProjectPawn::OnHandbrakePressed()
{
	GetVehicleMovementComponent()->SetHandbrakeInput(true);
}

void AVehicleAIProjectPawn::OnHandbrakeReleased()
{
	GetVehicleMovementComponent()->SetHandbrakeInput(false);
}

void AVehicleAIProjectPawn::OnToggleCamera()
{
	EnableIncarView(!bInCarCameraActive);
}

void AVehicleAIProjectPawn::EnableIncarView(const bool bState)
{
...
void AVehicleAIProjectPawn::Tick(float Delta)
{
...
void AVehicleAIProjectPawn::OnResetVR()
{
#ifdef HMD_INTGERATION
...
void AVehicleAIProjectPawn::UpdateHUDStrings()
{
...
void AVehicleAIProjectPawn::SetupInCarHUD()
{
...
void AVehicleAIProjectPawn::UpdatePhysicsMaterial()
{
